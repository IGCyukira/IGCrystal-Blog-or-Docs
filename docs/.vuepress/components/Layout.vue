...
import VPBackToTop from './BackToTop/VPBackToTop.vue'
import VPBackToTop2 from './BackToTop/VPBackToTop2.vue'
...
import { registerWatchers, useData, useEncrypt, useSidebarControl } from 'vuepress-theme-plume/composables'
