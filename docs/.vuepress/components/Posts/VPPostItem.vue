...
<template>
  ...
  >
    ...
    <div class="post-item-content">
      ...
      <span v-if="coverCompact" class="compact-arrow vpi-arrow-right" aria-hidden="true" />
    </div>
  </div>
</template>
...
.post-item-content :deep(a),
.post-item-content :deep(button),
.post-item-content :deep([role='button']) {
  pointer-events: auto;
}
...
.vp-post-item:hover .post-item-content h3 {
  color: var(--vp-c-brand-1);
}
...
.vp-post-item:hover .post-item-content h3 .sticky {
  color: var(--vp-c-text-2);
}
...
.vp-post-item:hover .compact-arrow {
  color: var(--vp-c-brand-1);
